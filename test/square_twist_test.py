...
def square_twist_test(do_n4b5=False):
    ...
    # load = np.array([[0, 1, -1, 5]], dtype=float)
    ...
    # save_object("twist_test", (truss, angles, analy_input_opt, u_his, f_his))
    truss, angles, analy_input_opt, u_his, f_his = load_object("twist_test")
